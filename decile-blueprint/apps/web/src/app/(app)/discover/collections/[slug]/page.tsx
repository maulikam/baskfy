...
/**
 * `/discover/collections/[slug]` — one editorial shelf.
 *
 ...
 * whole consumer IA under `/discover` and a second top-level noun would fight it.
 */
  ...
  return (
    <SelectionProvider>
      ...
      <p className="text-sm text-muted-foreground">
        <Link href="/discover/collections" className="hover:underline">
          All collections
        </Link>
      </p>
