...
/**
 * `/watchlist` — SC6. Count, watch date, moved-since-watchlisted, CTA to basket.
 */

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: PAGES["/me/watchlist"].title,
  description: PAGES["/me/watchlist"].blurb,
...
export default async function WatchlistPage() {
  ...
  return (
    <div className="flex max-w-3xl flex-col gap-6">
      ...
      <PageHeader
        title={PAGES["/me/watchlist"].title}
        blurb={PAGES["/me/watchlist"].blurb}
        meta={
