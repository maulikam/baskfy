...
from baskfy_providers.errors import AccessTokenExpired, CredentialsMissing, UnexpectedPayload
    ...
    def _fernet(self) -> Fernet:
        if not self._encryption_key:
            raise CredentialsMissing(
                "BASKFY_KITE_TOKEN_ENCRYPTION_KEY is not set, so the access token cannot be "
        ...
        try:
            ...
            raise CredentialsMissing(
                "BASKFY_KITE_TOKEN_ENCRYPTION_KEY is not a valid Fernet key "
