...
* **The reference page loads a script from a CDN.** ``BASKFY_REDOC_SCRIPT_URL`` pins the version
...
def render_document(document: Mapping[str, object]) -> str:
    """Byte-stable JSON, for the same reason ``baskfy_api.openapi`` sorts its keys."""
