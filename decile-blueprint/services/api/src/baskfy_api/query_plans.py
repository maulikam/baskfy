...
from baskfy_api.market_data import ListingQuery, listings_statement
from baskfy_api.screener import latest_published_date
...
def write_baseline(observed: Mapping[str, Mapping[str, str]], path: Path = BASELINE_PATH) -> None:
    document = {
        "_comment": (
            "Generated by `python -m baskfy_api.query_plans --write` against the seeded "
