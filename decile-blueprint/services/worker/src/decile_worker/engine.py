"""Wires ``decile_core.factors`` into the pipeline (Prompt 5 deliverable 5).
...
from decile_core.factors import DEFAULT_FACTOR_CONFIG, FactorConfig, FactorResult
from decile_core.factors import compute_factors as compute_factor_frame
...
async def load_history(
    ...
    """Read everything ``decile_core.factors`` needs for one as-of date."""
