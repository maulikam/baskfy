...
from decile_core.models import PipelineRun, PipelineRunStep
...
REQUEST_DURATION: Final = Histogram(
    "decile_http_request_duration_seconds",
...
SCREEN_CACHE: Final = Counter(
    "decile_screen_cache_events_total",
...
STEP_DURATION: Final = Histogram(
    "decile_pipeline_step_duration_seconds",
...
LAST_STEP_DURATION: Final = Gauge(
    "decile_pipeline_last_step_duration_seconds",
...
LAST_STEP_ROWS: Final = Gauge(
    "decile_pipeline_last_step_rows_out",
...
PUBLISH_LATENCY: Final = Gauge(
    "decile_publish_latency_seconds",
...
#: ``decile_pipeline_run_status{status="failed"} == 1`` an alert that never resolves.
