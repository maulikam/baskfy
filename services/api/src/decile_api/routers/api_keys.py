...
from decile_core.api_keys import KEY_TOKEN_MARKER, Scope, normalise_scopes
from decile_core.models import ApiKey
from decile_core.public_api import DATA_REDISTRIBUTION_REVIEW
...
async def rotate_api_key(
    ...
    """Issue a replacement and revoke the original immediately — see ``decile_api.api_keys``."""
    settings: Settings = settings_for(request)
